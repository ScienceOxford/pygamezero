...
5: If the player would end up on some floor, then they do move
'''
def on_key_down(key):
    global keyboard
...
def shop_dialog():
    ...
    if question == 0:
        if keyboard == 'i':
            ...
            shop_text = "Would you like to buy something? I have " + str(len(shopkeeper_items)) + " types of tea for sale today!" + "\n" + "Type Y or N"
            question = 1
