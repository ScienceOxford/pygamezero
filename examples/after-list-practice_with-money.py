...
"""
def shop():
    global text_box, keyboard, progress, location, player_money, shopkeeper_money
        ...
        if isinstance(keyboard, int):
            if 0 <= keyboard < len((shopkeeper_items)):
                if player_money >= 5:
                    ...
                    player_money -= shopkeeper_item_cost
                    shopkeeper_money += shopkeeper_item_cost
                    print(player_items)
                    print(player_money)
                    progress = 0
                else:
                    text_box = "You can't afford that! Goodbye." + "\n" + "Press ESCAPE to end the conversation."
                    progress = 0
